...
The learner-directed proposal lifecycle, idempotent approval, rejection, MCP + RAG + safe-write, provider comparison, and approval-bypass experiments are in [LAB.md](LAB.md).
