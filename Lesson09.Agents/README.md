...
The full agent walkthrough—including conversation history, MCP, knowledge retrieval, safe-write boundaries, provider/model settings, unsupported-provider handling, provider comparison, and the new bounded-tool coding challenge—is in [LAB.md](LAB.md).
